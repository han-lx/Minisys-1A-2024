...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_8 -L xbip_pipe_v3_0_4 -L xbip_bram18k_v3_0_4 -L mult_gen_v12_0_13 -L xil_defaultlib -L secureip -L xpm --snapshot mult xil_defaultlib.mult -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mult -key {Behavioral:sim_1:Functional:mult} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mult.wdb xsim.dir)
