...
#
# Generated by export_simulation on Tue Nov 12 17:54:25 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './div.sh' script.
...
./div.sh -noclean_files

For more information on the script, please type './div.sh -help'.
